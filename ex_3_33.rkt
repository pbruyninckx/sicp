...
(define (celcius-fahrenheit-convertor c f)
...
;(define (squarer a b)
;  (multiplier a a b))
; The system doesn't know that a can be derived from b,
; since the multiplier doesn't know both a-values should be identical
...
(define FF (celsius-fahrenheit-converter CC))